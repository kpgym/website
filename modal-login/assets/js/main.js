...
function closeModal() {
    if (document.getElementById('modal-container-login').classList.contains('show-modal')) {
        const modalContainer = document.getElementById('modal-container-login')
        modalContainer.classList.remove('show-modal')
    } else if (document.getElementById('modal-container-register').classList.contains('show-modal')) {
...
const validateField = (expresion, input, field) => {
    if (expresion.test(input.value)) {
        document.getElementById(`line__span-${field}`).classList.remove('line__span-error')
        document.getElementById(`line__span-${field}`).classList.add('line__span-correct')
        ...
        document.getElementById(`line__span-${field}`).classList.remove('line__span-correct')
        document.getElementById(`line__span-${field}`).classList.add('line__span-error')
        if (field == 'email_login' || field == 'password_login') {
